...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' + path + '/config/CSS/resources/css/ext-all' + suffix + '-debug.css"/>');
        console.log('<link rel="stylesheet" type="text/css" href="' + path + '/config/CSS/resources/css/ext-all' + suffix + '-debug.css"/>');
    }
    document.write('<script type="text/javascript" src="' + path + '/config/JS/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
    console.log('<script type="text/javascript" src="' + path + '/config/JS/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
