...
class Report_bch extends CI_Controller {
...
//                debux($retval['data_mch']);die;
	...
	public function get_data_bch_pdf(){
...
//                debux($retval['data_mch']);die;
		...
		//debux($retval);die;
		$this->load->view('templates/report/ete_report_bch_pdf', $retval);	
	}
	
	public function get_data_bch_show(){
		...
		// debux($retval);die;
		$this->load->view('templates/report/ete_report_bch_show', $retval);	
	}
}