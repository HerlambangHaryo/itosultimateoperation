...
<tr height="30px" class="tabMainTabelVesServ1" align="center"><td valign="middle"  width="20" class="tdBorderVesServ">No.</TD>
	<td valign="middle" width="200" class="tdBorderVesServ" colspan="2">Service Lane</TD>
	<td valign="middle" width="250" class="tdBorderVesServ" >Operator</TD>
	<td valign="middle" width="250" class="tdBorderVesServ">Port</TD>
...
<td class="<?if(($i%2)!=0){ echo 'oddrowcolor';}else{ echo 'evenrowcolor'; }?>"><?=$rowSe['ID_VESSEL_SERVICE'];?></td>
<td class="<?if(($i%2)!=0){ echo 'oddrowcolor';}else{ echo 'evenrowcolor'; }?>"><?=$rowSe['VESSEL_SERVICE_NAME'];?></td>
...
<td class="<?if(($i%2)!=0){ echo 'oddrowcolor';}else{ echo 'evenrowcolor'; }?>"><?php
	$rsd=$this->vessel->getServOp($rowSe['ID_VESSEL_SERVICE']);
	foreach($rsd as $rowSe2){
		echo $rowSe2['ID_OPERATOR'].' ';
	}
?> </td>
<td class="<?if(($i%2)!=0){ echo 'oddrowcolor';}else{ echo 'evenrowcolor'; }?>">
<?php
	$rsd2=$this->vessel->getServPrt($rowSe['ID_VESSEL_SERVICE']);
	foreach($rsd2 as $rowSe3){
		echo $rowSe3['ID_PORT'].' ';
	}
?><br>
</td>
